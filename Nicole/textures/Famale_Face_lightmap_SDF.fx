//by bilibili@三金络合物
#define FACESHADOW "GI_FaceShadow_Controller.pmx"
//在此设置控制器的名称，请确保他们在同一目录下。

float3 fpos : CONTROLOBJECT<string name=FACESHADOW; string item = "Face_Position";>;
float3 fdic : CONTROLOBJECT<string name=FACESHADOW; string item = "Face_Direction";>;
float3 fdic2 : CONTROLOBJECT<string name=FACESHADOW; string item = "Face_Direction2";>;
float3 lpos : CONTROLOBJECT<string name=FACESHADOW; string item = "Light_Position";>;
float3 ldic : CONTROLOBJECT<string name=FACESHADOW; string item = "Light_Direction";>;
float3 ldc : DIRECTION< string Object = "Light";>;
float sunon : CONTROLOBJECT<string name=FACESHADOW; string item = "Sunlight_On";>;
float yshield : CONTROLOBJECT<string name=FACESHADOW; string item = "Y_Axis_Shield";>;
float clflip : CONTROLOBJECT<string name=FACESHADOW; string item = "Color_Flip";>;
...
#define OCCLUSION_MAP_APPLY_SCALE .
...
//CUSTOM为8时是卡通着色效果，请确保Ray.conf配置文件中已经打开TOON的设置

#define CUSTOM_A_MAP_FROM 1
#define CUSTOM_A_MAP_UV_FLIP 4
//当本参数为4时，才会进行阴影翻转的计算，否则可能出错
#define CUSTOM_A_MAP_COLOR_FLIP 0
#define CUSTOM_A_MAP_SWIZZLE 0
#define CUSTOM_A_MAP_APPLY_SCALE 1
#define CUSTOM_A_MAP_FILE "Famale_Face_lightmap.png"
//请在此设置阴影贴图文件的路径，并确保他们在同一目录下
...
static const float3 customB = float3(0.65, 0.5, 0.5);
const float2 customBMapLoopNum = 1.0;

#include "GI_FaceShadow_Matcap.fxsub"
